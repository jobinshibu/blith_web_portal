          ...
          <div className="tab-pane-profile">
            ...
            <div className="app-download-section">
              ...
              <div className="download-buttons">
                <a href="https://play.google.com/store" target="_blank" rel="noopener noreferrer" className="badge-btn">
                ...
                <a href="https://apps.apple.com" target="_blank" rel="noopener noreferrer" className="badge-btn">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
